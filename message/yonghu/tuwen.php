...
session_start();
date_default_timezone_set('PRC');			//初始化SESSION变量
...
<div class="header">
    <div class="con">
        <div class="header-log">
            <div class="lr">  <a href="index.php" >	Cat Message Board&nbsp;&nbsp;&nbsp; </a>
            <a href="tuliuyan.php" >留言 </a>&nbsp;
            <a href="tuchaxun.php">查询 </a> &nbsp; 
            </div>
        </div>
...
?>
  ...
  ?></p>
                                        ...
                                        <p class="person">
                                        <a href=tuzan.php?action=<?php echo $rows[0];?>&zan=<?php echo $rows[6];?>> <span class="glyphicon glyphicon-thumbs-up"></a> <?php
                                        if( $rows[6]==null){
                                            echo 0;
                                        }else{
                                            echo $rows[6];
                                        ...
                                        ?>
                                        <a href="tuping.php?action=<?php echo $rows[0];?>">评论</a>
                                            <?php
