...
<?php
      ...
      $str=$_SESSION['user'];											
	$pagesize = 6;									//每页显示记录数
    $sqlstr = "select * from tb_liu WHERE userid="."'". $str."'  order by id desc";//定义查询语句
...
?>
                        <li>
                                ...
                                <div class="info">
                                        ...
                                        ?></p>
                                        <a href=update.php?action=<?php echo $rows[0];?>>修改</a>/<a href=delete.php?action==<?php echo $rows[0];?> >删除</a></td>
