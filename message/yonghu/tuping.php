...
<div class="header">
    <div class="con">
        <div class="header-log">
            <div class="lr">
            <a href="tuwen.php" >Cat Message Board </a>&nbsp;
...
<div class="seckill">
 ...
 $sqlstr = "select * from tb_tu where id = " . $_GET['action']; //定义查询语句
 ...
 <div class="liuyan">
      ...
      <img src="<?php echo $rows[2] ?>" alt="" style="width:300px;height:200px;">
     <p> <span class="glyphicon glyphicon-book"></span><?php echo $rows[3] ?></p>
     </div>
     <?php
     if($rows[7]==null){
        ?>
         <form name="form1" method="post" action="tuping_ok.php">
         评论：<input  class="txt" type="text" name="ping" size="50"  >
         <input type="hidden" name="id" value="<?php echo $rows[0] ?>">
         <input type="hidden" name="jiu" value="<?php echo $rows[7] ?>">
         <input type="submit" name="Submit" class="btn btn-primary " value="评论">
         </form>

 <?php
     }else{
         $pingarr=explode("/n",$rows[7]);
