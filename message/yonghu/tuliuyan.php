...
&nbsp;用&nbsp;户&nbsp;名：</br><input type="text" class="txt" name="user" size="20" >
</br>

图片地址：</br><input type="text" class="txt" name="src" size="20" ><p></br>
留&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;言：</br>
...
if(isset($_POST["submit"]) && $_POST["submit"]=="提交"){
    if($_POST["user"]!=''&&$_POST["pwd"]!=''){
        ...
        $pwd=$_POST["pwd"];
        $src=$_POST["src"];
       $sql="insert into tb_tu(name,src,liuyan,userid) values ("."'".$user."'".","."'".$src."',"."'".$pwd."'".",'".$_SESSION['user']."')";
             echo $sql;
    ...
    echo "<script>window.location.href=\"tuwen.php\"; </script>";
        }else{
            echo "留言失败";
        }
    }
